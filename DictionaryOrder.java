...
public class DictionaryOrder {
  public static void main(String[] args) {
    ...
    System.out.print("Make up the nameof a programming langugage! ");
...
/*Study Drill: Using teqnique of choice make this program work correctly
even if the human types the words in different capitalization. */
  }
}
